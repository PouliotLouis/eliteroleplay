...
return {
    ...
    policeAlertChance = 0.50,      -- Chance of alerting the police during the day
    policeNightAlertChance = 0.30, -- Chance of alerting the police at night (times: 01-07)
    policeAlertNightStartHour = 1,
    policeAlertNightDuration = 6,
