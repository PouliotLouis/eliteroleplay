return {
    ...
    pauseMapText = 'Élite RolePlay ⚜️', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
    ...
    characters = {
        ...
        dateMin = '1930-01-01', -- Has to be in the same format as the dateFormat config
