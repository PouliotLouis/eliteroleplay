return {
    ...
    EnterPrisonAlert  = {
        enable = true,
        header = 'Vous êtes en prison...',
        content = "Pour réduire ton temps en prison, trouve un boulot auprès du garde dans les cellules. Bouge-toi le cul et peut-être que t’apprendras deux-trois trucs.",
    },
