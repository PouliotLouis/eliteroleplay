...
Strings = {
    ...
    no_nearby = 'Personne introuvable',
    ...
    spawn_blocked = 'Garage',
    spawn_blocked_desc = 'Toutes les places de stationnement sont occupées !',
    ...
    on_duty = 'Status du service',
    on_duty_desc = 'Vous êtes maintenant en service !',
    off_duty = 'Status du service',
