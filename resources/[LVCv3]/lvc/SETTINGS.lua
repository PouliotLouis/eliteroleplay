...
------------------MENU KEYBINDING------------------
-- Commented out the code so players can't change the settings in the menu.
-- Search for 087182n3277723
open_menu_key = ''
...
-- J'ai désactivé le HUD, search for LVC HUD
