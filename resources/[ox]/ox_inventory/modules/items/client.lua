...
Item('bulletproof_vest_light', function(data, slot)
	if GetPedArmour(cache.ped) < 30 then
		ox_inventory:useItem(data, function(data)
			if data then
...
Item('bulletproof_vest_heavy', function(data, slot)
...
Item('bulletproof_vest_military', function(data, slot)
...
Item('bulletproof_vest_police', function(data, slot)
	if GetPedArmour(cache.ped) < 100 then
		ox_inventory:useItem(data, function(data)
			if data then
				SetPlayerMaxArmour(PlayerData.id, 100)
