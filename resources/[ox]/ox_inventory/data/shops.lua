return {
	General = {
		...
		blip = {
			...
			{ name = 'water', price = 4 },
			{ name = 'burger_chicken', price = 17 },
			{ name = 'baking_soda', price = 25}
		}, locations = {
	...
	BlackMarketArms = {
		name = "Vendeur d'armes illégales",
		inventory = {
			{ name = 'WEAPON_REVOLVER_MK2', price = 12500, metadata = { registered = false	}, currency = 'black_money' },
			{ name = 'WEAPON_MICROSMG', price = 20000, metadata = { registered = false }, currency = 'black_money' },
			{ name = 'WEAPON_ASSAULTSMG', price = 34500, metadata = { registered = false }, currency = 'black_money' },
			{ name = 'ammo-44', price = 50, currency = 'black_money' },
	...
	PolicePharmacy = {
		...
		inventory = {
			{ name = 'bandage', price = false, grade = 0 },
			{ name = 'medikit', price = false, grade = 0 },
			{ name = 'painkillers', price = false, grade = 1 },
			{ name = 'defibrilateur', price = false, grade = 4 },
		},
		targets = {
			{ 
				loc = vec3(480.54, -991.79, 30.2),
				heading = 275.98,
                distance = 4.0,
                width = 2.0,
                length = 2.0,
